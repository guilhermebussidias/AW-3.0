...
<html lang="es">
	...
	<body>
		<div id="contenedor">
			...
			$prev=$ultimaPag - 1;
			if ($ultimaPag!=0) {
				echo '<a class="contenido-boton" href="noticia.php?ultimaPag='.$prev.'">Página anterior</a>';
			}
			...
			if (!$noticias==null) {
				echo "<a class='contenido-boton' href='noticia.php?ultimaPag=" . $next ."'>Página siguiente</a>";
			}
